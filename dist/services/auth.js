 ...
 */
exports.login = function (user) { return __awaiter(_this, void 0, void 0, function () {
    var token;
 ...
 */
exports.verify = function (user) { return __awaiter(_this, void 0, void 0, function () {
    var userDocument;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, userService.find({ uuid: user.uuid })];
            case 1:
 ...
 * @return {Object} The user's document from the database minus password
 */
exports.register = function (body) { return __awaiter(_this, void 0, void 0, function () {
    var user;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, userService.create(body)];
            case 1:
                user = _a.sent();
